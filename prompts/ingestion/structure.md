# Structure Stage Launcher

stage: Structure
speech_id: {{speech_id}}
input: speeches/{{speech_id}}/01-transcript.md
target_output: speeches/{{speech_id}}/02-structure.yaml
...
Stop after the Structure-stage gate.
Do not proceed to Tags.
